...
namespace LoGa.LudoEngine.Game
{
    public class Berry
    {
        ...
        private const float SPAWN_MIN_DISTANCE = 10f;   // Minimum 8m from player
        private const float SPAWN_MAX_DISTANCE = 12f;  // Maximum 10m from player  
        private const float COLLECTION_RADIUS = 8f;    // 3m collection radius for GPS accuracy
