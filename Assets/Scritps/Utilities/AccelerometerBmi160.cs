...
namespace LoGa.LudoEngine.Utilities
{
	public class AccelerometerBmi160
	{
		...
		public static byte[] Configure (Module module = Module.ACCELEROMETER, OutputDataRate odr = OutputDataRate._100Hz, DataRange range = DataRange._2g, FilterMode filter = FilterMode.Normal)
		{
		...
		{
			return sendCommand (Module.ACCELEROMETER, DATA_INTERRUPT_ENABLE, new byte[] { 0x01 });
		}

		public static byte[] DataInterruptStop ()
		{
			return sendCommand (Module.ACCELEROMETER, DATA_INTERRUPT_ENABLE, new byte[] { 0x00 });
		}

		public static byte[] DataStart()
		{
			return sendCommand (Module.ACCELEROMETER, DATA_INTERRUPT, new byte[] { 0x01, 0x00 });
		}

		public static byte[] DataStop()
		{
			return sendCommand (Module.ACCELEROMETER, DATA_INTERRUPT, new byte[] { 0x00, 0x01 });
		}

		public static byte[] Start ()
		{
			return sendCommand (Module.ACCELEROMETER, POWER_MODE, new byte[] { 0x01 });
		}

		public static byte[] Stop ()
		{
			return sendCommand (Module.ACCELEROMETER, POWER_MODE, new byte[] { 0x00 });
		}
